          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              <select name="status_peserta" value={form.status_peserta} onChange={handleChange}
                className={`w-full border rounded-lg px-3.5 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500 transition bg-white ${errors.status_peserta ? "border-red-400 bg-red-50" : "border-stone-300"}`}>
                <option value="aktif">Aktif</option>
                <option value="lulus">Lulus</option>
                <option value="tidak_lulus">Tidak Lulus</option>
              </select>
              {errors.status_peserta && <p className="text-red-500 text-xs mt-1">{errors.status_peserta}</p>}
            </div>
            <div>
